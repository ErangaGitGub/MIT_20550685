...
public class UserController {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Consumes(MediaType.APPLICATION_JSON)
    public String getBranchUserData(@HeaderParam("apiKey") String key, String jsonData) {
...
//        String branchUserData = "";
        try {
            ...
            if (!authontication.isUserAuthenticated(key)) {
                ...
                if (!jsonRequestObj.has("pfNumber")) {
                    jsonResponseObject.put("errorStatus", true);
                    jsonResponseObject.put("errorMessage", "PF Number  is required.");
                }else{
                    UserHandler handler = new UserHandler();
                    String responseString = handler.getBranchUserData(jsonRequestObj.getString("pfNumber"));
                    ...
                    try {
                        ...
                        logger.warn("Error in getBranchUserData - Json", err);
                   }
  ...
  @POST
        ...
        try {
            if (!authontication.isUserAuthenticated(key)) {
                ...
                if (!jsonObj.has("pfNumber")) {
                    ...
                    jSONObject.put("errorStatus", true);
                    jSONObject.put("errorMessage", "Password  is required.");
                    return jSONObject.toString();
                }else if (!jsonObj.has("userName")) {
                    jSONObject.put("errorStatus", true);
                    jSONObject.put("errorMessage", "Name  is required.");
                    return jSONObject.toString();
                }else if (!jsonObj.has("branch")) {
                    jSONObject.put("errorStatus", true);
                    jSONObject.put("errorMessage", "Branch  is required.");
                    return jSONObject.toString();
                    ...
                    UserHandler handler = new UserHandler();
                    response = handler.insertUserData(pfNumber,password,userName,branch,ip,host,user);
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Consumes(MediaType.APPLICATION_JSON)
    public String resetUserPassword(@HeaderParam("apiKey") String key, String formJson) {
        ...
        try {
            if (!authontication.isUserAuthenticated(key)) {
                ...
                if (!jsonObj.has("pfNumber")) {
                    ...
                    UserHandler handler = new UserHandler();
                    response = handler.resetPassword(jsonObj);
                }
            }
        } catch (Exception ex) {
            logger.warn("Error in resetUserPassword", ex);
        }
        return response;
    }
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Consumes(MediaType.APPLICATION_JSON)
    public String changeUserPassword(@HeaderParam("apiKey") String key, String formJson) {
        logger.debug("resetUserPassword");
        ApiAuthontication authontication = new ApiAuthontication();
        JSONObject jSONObject = new JSONObject();
        String response = "";
        try {
            if (!authontication.isUserAuthenticated(key)) {
                ...
                if (!jsonObj.has("pfNumber")) {
                    ...
                    UserHandler handler = new UserHandler();
                    response = handler.changePassword(jsonObj);
                }
            }
        } catch (Exception ex) {
            logger.warn("Error in changeUserPassword", ex);
        }
        return response;
    }
