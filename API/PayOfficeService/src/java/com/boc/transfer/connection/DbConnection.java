...
//                "jdbc:as400:" + "icbs.bankofceylon.local" 
...
//                 "usrpayof");
        ...
        Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/payoffdb","root","");
    ...
    public static AS400 getAS400() {
        String HOST = "icbs.bankofceylon.local";
        String UID = "payofusr";
        String PWD = "usrpayof";
