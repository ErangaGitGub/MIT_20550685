 ...
 */
package com.boc.transfer.converter;
            ...
            if (TitleColumn.equals(rsx.getString(TitleCol))) {
                for (int i = 1; i < numColumns; i++) {
                    ...
                    if (rsmd.getColumnType(i) == java.sql.Types.ARRAY) {
                        ...
                        obj.put(column_name, rsx.getString(column_name).trim());
                    } else if (rsmd.getColumnType(i) == java.sql.Types.BIGINT) {
                        obj.put(column_name, rsx.getInt(column_name));
                    } else if (rsmd.getColumnType(i) == java.sql.Types.BOOLEAN) {
                        obj.put(column_name, rsx.getBoolean(column_name));
                        ...
                        obj.put(column_name, rsx.getNString(column_name).trim());
                    } else if (rsmd.getColumnType(i) == java.sql.Types.TINYINT) {
                        obj.put(column_name, rsx.getInt(column_name));
                    } else if (rsmd.getColumnType(i) == java.sql.Types.SMALLINT) {
                        obj.put(column_name, rsx.getInt(column_name));
