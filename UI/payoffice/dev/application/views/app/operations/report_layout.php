...
<div class="form-group pull-right" >
                ...
                <a id="ap-authbtn-rates" class="ap-btn ap-btn-opt continue">
                <span id="ap-btn-loading-nxt" style="display:none;"></span>
                <span>AUTHORIZE</span>
                <i class="fas fa-check"></i>
                </a> 

                <a id="ap-rejectbtn-rates" class="ap-btn ap-btn-opt" >
                <span>REJECT</span>
                <i class="fas fa-times"></i>
                </a>   
</div> -->
