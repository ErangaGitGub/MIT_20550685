...
<label class="app-input-label"><b>Day Begin Process Details</b></label>        
...
<div class="col-md-2 ap-sinp-col-for-inp-2" style="width: 25%; margin-top: 10px;">
<label class="ap-lbl-inp-txt" for="input-name"> DAY BEGIN</label>
</div>
</div>
...
<label class="ap-lbl-inp-txt" for="input-name"> This Process change the system date to the next working date </label>
</div>
</div>
...
<label id="id-precheck-status" class="ap-st-label ap-st-lb-completed" style="text-align: center; width: 40%;padding-left:5px;  padding-right:5px;  margin-left:90px;font color:#f44336;">Day Begin process executed for Today</label>
</div>
</div>
...
<div class="row form-group app-form-group app-form-group-first">
<label class="ap-lbl-inp-txt" for="input-name">Process Status: </label>
<label id="id-precheck-status"  style="text-align: center; width: 100px;padding-left:5px;  padding-right:5px;  margin-left:120px;font color:#f44336;"></label>
</div>
</div>
...
<div class="ap-btn-pannel" style="margin-top: 20px;">
        ...
        <a id="ap-btn-day-begin" class="ap-btn ap-btn-opt continue pull-left " >
        <span>DAY START</span>
