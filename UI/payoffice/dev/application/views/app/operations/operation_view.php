...
<label class="app-input-label"><b>Prior Check Process Details</b></label>        
...
<div class="col-md-2 ap-sinp-col-for-inp-2" style="width: 25%; margin-top: 10px;">
<label class="ap-lbl-inp-txt" for="input-name"> DAY END - PRE CHECK</label>
</div>
</div>
...
<div class="row form-group app-form-group app-form-group-first">
<div class="col-md-2 ap-sinp-col-for-inp-2" style="width: 25%; margin-top: 10px;">
<label class="ap-lbl-inp-txt" for="input-name">Last Checked By: </label>
</div>
<div class="col-md-2 ap-sinp-col-for-inp-2" style="width: 75%;  margin-top: 10px;">
<label class="ap-lbl-inp-txt" for="input-name"> IT207416</label>
</div>
</div>
...
<div class="row form-group app-form-group app-form-group-first">
<div class="col-md-2 ap-sinp-col-for-inp-2" style="width: 25%; margin-top: 10px;">
<label class="ap-lbl-inp-txt" for="input-name">Last Checked Time: </label>
</div>
<div class="col-md-2 ap-sinp-col-for-inp-2" style="width: 75%;  margin-top: 10px;">
<label class="ap-lbl-inp-txt" for="input-name"> 2020-12-15 434:343:343</label>
</div>
</div>
...
<div class="ap-btn-pannel" style="margin-top: 20px;">
        ...
        <a id="ap-btn-pre-check" class="ap-btn ap-btn-opt continue pull-left " >
        <span>PRE-CHECK</span>
