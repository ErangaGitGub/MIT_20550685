...
<li>
    ...
    <?php if (true): ?>        
    <a href="<?php echo $this->config->item('base_url');?>dashboard" class="ap-btn ap-btn-new ap-btn-theme">
    <span>Upload New Rates</span>&nbsp;&nbsp;
...
<span id="ap-upload-rates" class="ap-btn ap-btn-nxt" data-event="create" >
<span class="ap-btnloading-nxt" style="display:none;"><i class="fa fa-spinner fa-spin"></i></span>
<span> UPLOAD DAILY RATES</span>&nbsp;&nbsp;
<span>
...
<span id="ap-backbtn-uploadrates" class="ap-btn ap-btn-nxt" style="display:none;" data-event="create" >
...
<span id="ap-upload-confirm" class="ap-btn ap-btn-nxt" style="display:none;" data-event="create" >
...
<div class="form-group pull-right" style="margin-right: 15px;">
    <span  id="er-errorbutton" class="ap-lbl-inp-err" for="error-msg"></span>
</div>
</div>
