...
$url = $this->config->item('base_url')."transaction/print/exceptionTxn?txnNo=".$txn->referenceNo;
?>
...
// 	//javascript:window.print();
    ...
    window.location.href =  "<?php echo $this->config->item('base_url');?>opr/exceptions?subtitle=View Daily Exceptions Report - ISSUING | WITHDRAWAL" class="btn btn-dpurple btn-lg";
};
