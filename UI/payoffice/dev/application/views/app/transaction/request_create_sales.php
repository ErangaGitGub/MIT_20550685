...
<div class="col-md-4 ap-sinp-col-for-inp-4">
<select id="id-uintype" class="selectpicker form-control ap-inp-field" data-dropup-auto="false" data-size="5" data-live-search="true" data-show-subtext="true" title="Select UIN Type"  name="uintype" tabindex="2">
...
<select id="id-title" class="selectpicker form-control ap-inp-field" data-dropup-auto="false" data-size="5" data-live-search="true" data-show-subtext="true" title="Select Title"   name="title" tabindex="4">
...
<select id="id-icurrencyselector1" class="selectpicker form-control ap-inp-field" name="icurrencyselector1" data-dropup-auto="false" data-size="5" data-live-search="true" data-show-subtext="true" title="Select"  tabindex="9">
...
<div class="col-md-2 ap-sinp-col-for-inp-1">
<select id="id-icurrencyselector3" class="selectpicker form-control ap-inp-field" name="icurrencyselector3" data-dropup-auto="false" data-size="5" data-live-search="true" data-show-subtext="true" disabled="" title="Select"  >
<?php if (isset($currencies)): ?> 
<?php foreach ($currencies as $tcurrency): ?> 
<?php if ( $tcurrency->CURSHRT != 'LKR'): ?>
<option value="<?php echo $tcurrency->CURSHRT; ?>" data-code="<?php echo $tcurrency->CURID; ?>" data-shrt="<?php echo $tcurrency->CURSHRT; ?>"><?php echo $tcurrency->CURSHRT; ?></option>
...
<input id="id-tamount1" class="form-control ap-inp-field  numsep calculateLkr " type="text" name="tamount1" autocomplete="off" autocorrect="off" spellcheck="false"  tabindex="10">
<span id="er-tamount1" class="ap-lbl-inp-err" for="error-msg"></span>
</div>

<div class="col-md-2 ap-sinp-col-for-inp-2">
<input id="id-tamount2" class="form-control ap-inp-field  numsep calculateLkr" type="text" name="tamount2" autocomplete="off" autocorrect="off" spellcheck="false" readonly="" >
<span id="er-tamount2" class="ap-lbl-inp-err" for="error-msg"></span>
</div>

<div class="col-md-2 ap-sinp-col-for-inp-2">
<input id="id-tamount3" class="form-control ap-inp-field  numsep calculateLkr" type="text" name="tamount3" autocomplete="off" autocorrect="off" spellcheck="false" readonly="" >
<span id="er-tamount3" class="ap-lbl-inp-err" for="error-msg"></span>
</div>

<div class="col-md-2 ap-sinp-col-for-inp-2">
<input id="id-tamount4" class="form-control ap-inp-field  numsep calculateLkr" type="text" name="tamount4" autocomplete="off" autocorrect="off" spellcheck="false" readonly="" >
...
<div class="col-md-2 ap-sinp-col-for-inp-2">
<input id="id-rate1" class="form-control ap-inp-field numdec  calculateLkr" type="text" name="rate1" autocomplete="off" autocorrect="off" spellcheck="false" readonly="true" tabindex="11">
...
<div class="col-md-2 ap-sinp-col-for-inp-2">
<input id="id-rate2" class="form-control ap-inp-field numdec  calculateLkr" type="text" name="rate2" autocomplete="off" autocorrect="off" spellcheck="false" readonly="" >
...
<div class="col-md-2 ap-sinp-col-for-inp-2">
<input id="id-rate3" class="form-control ap-inp-field numdec  calculateLkr" type="text" name="rate3" autocomplete="off" autocorrect="off" spellcheck="false"  readonly="">
...
<div class="col-md-2 ap-sinp-col-for-inp-2">
<input id="id-rate4" class="form-control ap-inp-field numdec  calculateLkr" type="text" name="rate4" autocomplete="off" autocorrect="off" spellcheck="false"  readonly="">
...
<div>
<div class="col-md-4 ap-sinp-col-for-lbl">
<label class="ap-lbl-inp-txt" for="input-name">Commision Fee:</label>
</div> 
<div class="col-md-2 ap-sinp-col-for-inp-1">
<input id="id-commision-percentage"   class="form-control ap-inp-field calculateLkr" type="number" step="any" name="commision-percentage" autocomplete="off" autocorrect="off" spellcheck="false"    readonly="">
<span id="er-commision-percentage" class="ap-lbl-inp-err" for="error-msg"></span>
</div>
<div class="col-md-2 ap-sinp-col-for-inp-1">
<input id="id-commision" class="form-control ap-inp-field" type="text" name="commision" autocomplete="off" autocorrect="off" spellcheck="false"    readonly="">
<span id="er-commision" class="ap-lbl-inp-err" for="error-msg"></span>
</div>


<div class="col-md-4 ap-sinp-col-for-inp-1" style="">
<a id="ap-btn-exclude-commision" name="exludecommision" class="ap-btn ap-cal-btn"   ng-click ="commision=true" ng-hide="commision" class="ap-btn ap-btn-opt " style="width: 100%; height: 100%;">
<span><i class="fas fa-edit"></i></span>
&nbsp;EXCLUDE/CHANGE COMMISION&nbsp;
<span id="ap-btn-loading-bref-vrfy" style="display:none;"><i class="fa fa-spinner fa-spin"></i></span>
</a>

<a id="ap-btn-include-commision" name="includecommision"  class="ap-btn ap-cal-btn"   ng-click ="commision=false"  ng-show="commision" class="ap-btn ap-btn-opt "  style="width: 100%; height: 100%;">
...
<div class="col-md-8 ap-sinp-col-for-inp-1" >
<input id="id-commreason" class="form-control ap-inp-field" type="text" name="commreason" minlength="8" maxlength="13" autocomplete="off" autocorrect="off" spellcheck="false" style="text-transform:uppercase" tabindex="12">
...
<div>
<div class="col-md-4 ap-sinp-col-for-lbl">
<label class="ap-lbl-inp-txt" for="input-name">Ceiling/Floor Commision : &nbsp;&nbsp; <span id="ap-btn-loading-incentive3" style="display:none;"><i class="fa fa-spinner fa-spin"></i></span></label>
</div> 
...
<div class="col-md-8 ap-sinp-col-for-inp-1">
<input id="id-receivedAmount" class="form-control ap-inp-field  numsep calculateRefund" type="text" name="receivedAmount" autocomplete="off" autocorrect="off" spellcheck="false"   tabindex="13" >
...
<div class="col-md-8 ap-sinp-col-for-inp-1">
<input id="id-refundAmount" class="form-control ap-inp-field" type="text" name="refundAmount" autocomplete="off" autocorrect="off" spellcheck="false"    readonly="">
...
<div class="col-md-8 ap-sinp-col-for-inp-1">
<textarea id ="id-remarks" name="remarks" class="form-control ap-inp-field" tabindex="14"></textarea>
...
<span id="ap-nxtbtn-sales" class="ap-btn ap-btn-nxt" data-event="create" >
<span class="ap-btnloading-nxt" style="display:none;"><i class="fa fa-spinner fa-spin"></i></span>
...
<span id="ap-backbtn-sales" class="ap-btn ap-btn-nxt" style="display:none;" data-event="create" >
...
<span id="ap-savbtn-sales" class="ap-btn ap-btn-nxt" style="display:none;" data-event="create" >
...
<div id="ap-modal-container">
    ...
    <div id="ap-modal-content" class="modal-content">
        ...
        <div class="col-md-6 ap-sinp-col-for-inp-1">
        	<input id="id-com-fixed" class="form-control ap-inp-field " type="number" step="any" name="comFixed" minlength="8" maxlength="11" autocomplete="on" autocorrect="on" spellcheck="false" style="text-transform:uppercase"  readonly="true" enabled>
        </div>
        <div class="col-md-6 ap-sinp-col-for-inp-1">
        	<input id="id-com-rate" class="form-control ap-inp-field " type="number" step="any" name="comRate" minlength="8" maxlength="11" autocomplete="on" autocorrect="on" spellcheck="false" style="text-transform:uppercase"   readonly="">
        </div>
        ...
        <div id="ap-modal-footer" class="app-modal-footer">
        	<a id="ap-btn-continue" class="ap-btn ap-btn-modal" data-dismiss="modal" ><span id="ap-btn-loading-conf" style="display:none;"><i class="fa fa-spinner fa-spin"></i></span>&nbsp;<span>CONTINUE</span>&nbsp;<span><i class="fas fa-check"></i></span></a>
