...
<div class="col-md-4 ap-sinp-col-for-inp-1">
<input id="id-accountnumber" class="form-control ap-inp-field" type="text" name="accountnumber" minlength="5" maxlength="11" autocomplete="off" autocorrect="off" spellcheck="false" tabindex="6" >
...
<div>	
<div class="col-md-4 ap-sinp-col-for-lbl" >
<label class="ap-lbl-inp-txt" for="input-name">Account Currency Type:</label>
</div> 
<div class="col-md-8 ap-sinp-col-for-inp-1">
<input id="id-currtype" class="form-control ap-inp-field" type="text" name="currtype" autocomplete="off" autocorrect="off" spellcheck="false"   readonly="">
...
<div class="col-md-8 ap-sinp-col-for-inp-1">
<input id="id-airticket" class="form-control ap-inp-field" type="text" name="airticketno" autocomplete="off" autocorrect="off" spellcheck="false"  tabindex="7">
</div>
</div>
</div>
...
<div class="col-md-8 ap-sinp-col-for-inp-1">
<select id="id-majorcountry" class="selectpicker form-control ap-inp-field" name="majorcountry" data-dropup-auto="false" data-size="5" data-live-search="true" data-show-subtext="true" title="Select Country Code" tabindex="8" >
...
<div class="col-md-2 ap-sinp-col-for-inp-2">
<input id="id-rate1" class="form-control ap-inp-field numdec  calculateLkr" type="text" name="rate1" autocomplete="off" autocorrect="off" spellcheck="false" readonly="true" >
...
TILL CASH IN
 ...
 <div class="ap-sinp-elm" style="display:none;">
<div class="row form-group ap-sinp-wrapper"">
<div>
<div class="col-md-4 ap-sinp-col-for-lbl">
...
<div class="col-md-8 ap-sinp-col-for-inp-1">
<input id="id-receivedAmount" class="form-control ap-inp-field numdec numsep calculateRefund" type="text" name="receivedAmount" autocomplete="off" autocorrect="off" spellcheck="false"    >
...
<div>
<div class="col-md-4 ap-sinp-col-for-lbl">
<label class="ap-lbl-inp-txt" for="input-name">Total Amount to Commision A/C : &nbsp;&nbsp; <span id="ap-btn-loading-incentive3" style="display:none;"><i class="fa fa-spinner fa-spin"></i></span></label>
</div> 
<div class="col-md-4 ap-sinp-col-for-inp-1">
...
<div class="col-md-8 ap-sinp-col-for-inp-1">
<textarea id ="id-remarks" name="remarks" class="form-control ap-inp-field" tabindex="12"></textarea>
<span id="er-comgltotal" class="ap-lbl-inp-err" for="error-msg"></span>
</div>
</div>
</div>
...
<span id="ap-nxtbtn-issue" class="ap-btn ap-btn-nxt" data-event="create" >
<span class="ap-btnloading-nxt" style="display:none;"><i class="fa fa-spinner fa-spin"></i></span>
...
<span id="ap-backbtn-issue" class="ap-btn ap-btn-nxt" style="display:none;" data-event="create" >
...
<span id="ap-savbtn-issue" class="ap-btn ap-btn-nxt" style="display:none;" data-event="create" >
