...
<table id="ap-data-table" class="ap-data-table" style="width:100%">
   ...
   <?php echo number_format(floatval($item->CURBAL),2); ?>
    ...
    <input id="<?php echo $item->CURID; ?>" class="form-control ap-inp-field numdec " type="text" name="<?php echo $item->CURSHRT; ?>" value="<?php echo number_format(floatval(0),2); ?>" autocomplete="off" autocorrect="off" spellcheck="false" tabindex="1" >
