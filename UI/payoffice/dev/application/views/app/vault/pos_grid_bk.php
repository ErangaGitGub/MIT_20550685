...
<table id="ap-data-table" class="ap-data-table" style="width:100%">
   ...
   <?php echo $item->CURDESC; ?>
    ...
    <td>
    <input id="<?php echo $item->CURID; ?>" class="form-control ap-inp-field" type="text" name="<?php echo $item->CURSHRT; ?>" value="<?php echo $item->CURDESC; ?>" minlength="8" maxlength="11" autocomplete="off" autocorrect="off" spellcheck="false" tabindex="1" >
    </td>
