...
<table id="ap-data-table" class="ap-data-table" style="width:100%">
    ...
    <th class="text-center">SOURCE TILL BALANCE</th>    
   ...
   <?php echo $item->CURDESC; ?>
    ...
    <td>
    <center>
    <?php echo number_format(floatval($item->CURBAL),2); ?>
   
    </td>

    <td>
    <input id="<?php echo $item->CURSHRT; ?>" class="form-control ap-inp-field numdec " type="text" name="<?php echo $item->CURSHRT; ?>"  value="<?php echo number_format(floatval(0),2); ?>"    autocomplete="off" autocorrect="off" spellcheck="false" tabindex="1" required="">

    <span id="er-<?php echo $item->CURSHRT; ?>" class="ap-lbl-inp-err" for="error-msg"></span>
    ...
    <input class="form-control ap-inp-field" id="id-hiddensourcetill" type="hidden" name="hiddensourcetill"  value=<?php if (isset($sourcetill)): ?> <?php echo $sourcetill ?> <?php endif ?> >
</table>
