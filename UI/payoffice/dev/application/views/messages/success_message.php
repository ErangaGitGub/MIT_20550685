...
<!-- #header -->
<div id="ap-modal-header" class="app-modal-header ap-modal-header-succ">  
<span class="ap-modal-header-icon-succ"><i class="fas fa-check-circle"></i></span>&nbsp;&nbsp;<span class="ap-header-bold">Success</span>  
</div>
<!-- #header -->
...
if ($button['url']!=="") {
$html = $html.' href="'.$button['url'].'"';
} 

if (isset($button['data-dismiss']) && $button['data-dismiss']) {
