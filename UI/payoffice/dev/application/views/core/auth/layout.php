...
<div class="">
    ...
    <span><img src="<?php echo $this->config->item('public_url');?>images/assets/boc_logo.png" class="img_logo"  width="55" height="55" alt="boc-logo"></span>
...
<div class="panel-heading ap-lf-panel-footer text-center">
<span class="ap-lf-panel-footer-txt text-center">
